...
public class LanguageToolAnnotator implements Annotator {
    ...
    public static void main(String[] args) {
        ...
        properties.setProperty("languagetool.language", "it");
        properties.setProperty("customAnnotatorClass.languagetool", "eu.fbk.dh.tint.languagetool.LanguageToolAnnotator");
